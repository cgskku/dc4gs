...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.only_dcc = False
        self.const_split = 0.0
        self.const_scale = 1.0
        self.without_bound = False
        self.invalid_argmin = False
        self.inverse_op = False
        self.argmin_split = False
        self.const_opacity = 0.0
